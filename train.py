...
def unet(n_tissues):
    ...
    conv14 = Conv3D(16, small_conv_size, activation='relu', padding='same', use_bias=True)(conv13)
    # conv14 = Conv3D(16, small_conv_size, activation='relu', padding='same', use_bias=False)(conv14)
    drop14 = Dropout(0.3)(conv14)
    # bn14 = BatchNormalization()(drop14)
    conv15 = Conv3D(16, small_conv_size, activation='relu', padding='same', use_bias=False)(drop14)
    drop15 = Dropout(0.3)(conv15)
    # bn15 = BatchNormalization()(drop15)
    conv16 = Conv3D(32, mini_conv_size, activation='relu', padding='same', use_bias=False)(drop15)
    drop16 = Dropout(0.3)(conv16)
    conv17 = Conv3D(32, mini_conv_size, activation='relu', padding='same', use_bias=False)(drop16)
